...
import org.clickandeat.vista.ventana.adminSwing.MenuComentariosAdministradorSwing;
import org.clickandeat.vista.ventana.adminSwing.MenuInventarioSwing;
...
public class MenuAdministracionSwing extends JFrame {
    ...
    public MenuAdministracionSwing(Usuario usuario, UsuarioServicio usuarioServicio, JFrame menuAdministradorSwing) {
    ...
    private void mostrarPanelProducto() {
        ...
        panelProducto.setMaximumSize(new Dimension(1200, 350));
        ...
        tablaProducto.setPreferredScrollableViewportSize(new Dimension(1000, 250));
        JScrollPane scrollProducto = new JScrollPane(tablaProducto);
        scrollProducto.setPreferredSize(new Dimension(1050, 400));
        ...
        btnAgregarCategoria.addActionListener(e ->
                DialogosMenuAdministracion.dialogAgregarCategoria(this, categoriaServicio, categoriaTableModel)
        );
        btnEditarCategoria.addActionListener(e ->
                DialogosMenuAdministracion.dialogEditarCategoria(this, categoriaServicio, categoriaTableModel, tablaCategoria.getSelectedRow())
        );

        btnEliminarCategoria.addActionListener(e ->
                DialogosMenuAdministracion.dialogEliminarCategoria(
                        this,
                        categoriaServicio,
                        categoriaTableModel,
        ...
        btnAgregarProducto.addActionListener(e ->
                DialogosMenuAdministracion.dialogAgregarProducto(this, productoServicio, categoriaServicio, productoTableModel)
        );
        btnEditarProducto.addActionListener(e ->
                DialogosMenuAdministracion.dialogEditarProducto(this, productoServicio, categoriaServicio, productoTableModel, tablaProducto.getSelectedRow())
        );
        btnEliminarProducto.addActionListener(e ->
                DialogosMenuAdministracion.dialogEliminarProducto(this, productoServicio, productoTableModel, tablaProducto.getSelectedRow())
        );
    ...
    private void mostrarPanelPromociones() {
        panelCentral.removeAll();
        JLabel lbl = new JLabel("Panel Promociones (Aquí irá la gestión de promociones)");
        lbl.setFont(new Font(FUENTE_BONITA, Font.PLAIN, 24));
    ...
    private void mostrarPanelMenu() {
        panelCentral.removeAll();
        JLabel lbl = new JLabel("Panel Menú (Aquí irá la gestión del menú del día, etc.)");
        lbl.setFont(new Font(FUENTE_BONITA, Font.PLAIN, 24));
        lbl.setHorizontalAlignment(SwingConstants.CENTER);
        panelCentral.add(lbl, BorderLayout.CENTER);
        panelCentral.revalidate();
