...
public class MenuComentariosAdministrador extends JFrame {
    ...
    public MenuComentariosAdministrador(Usuario usuario, UsuarioServicio usuarioServicio, JFrame menuAdministradorSwing) {
