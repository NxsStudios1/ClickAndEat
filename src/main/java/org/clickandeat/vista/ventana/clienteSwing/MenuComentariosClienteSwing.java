...
public class MenuComentariosClienteSwing extends JFrame {
    ...
    public MenuComentariosClienteSwing(Usuario cliente, UsuarioServicio usuarioServicio, JFrame ventanaBienvenida) {
        ...
        lblSalir.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dispose();
                new MenuClienteSwing(cliente, usuarioServicio, ventanaBienvenida).setVisible(true);
            }
        });
    }
