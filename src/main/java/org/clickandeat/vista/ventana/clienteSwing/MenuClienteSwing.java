...
public class MenuClienteSwing extends JFrame {
    ...
    public MenuClienteSwing(Usuario cliente, UsuarioServicio usuarioServicio, JFrame ventanaBienvenida) {
        ...
        btnComentarios.addActionListener(e -> {
            MenuComentariosClienteSwing ventanaComentarios = new MenuComentariosClienteSwing(
